...
async def make_async_db_pair():
    """Create two independent async in-memory databases."""
...
class TestAsyncPydanticSaveDb:
    ...
    @pytest.mark.asyncio
    async def test_save_insert_to_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_save_update_in_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_save_default_behavior_unchanged(self):
    ...
    @pytest.mark.asyncio
    async def test_save_does_not_mutate_class_binding(self):
    ...
    @pytest.mark.asyncio
    async def test_save_alternating_databases(self):
...
class TestAsyncPydanticDeleteDb:
    ...
    @pytest.mark.asyncio
    async def test_delete_from_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_delete_default_uses_class_binding(self):
    ...
    @pytest.mark.asyncio
    async def test_delete_unsaved_raises(self):
    ...
    @pytest.mark.asyncio
    async def test_delete_with_policy_db_override(self):
...
class TestAsyncSafeSaveDb:
    ...
    @pytest.mark.asyncio
    async def test_safe_save_insert_to_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_safe_save_increments_version(self):
    ...
    @pytest.mark.asyncio
    async def test_safe_stale_raises_in_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_safe_rebase_in_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_safe_version_isolation(self):
...
class TestAsyncLiteSaveDb:
    ...
    @pytest.mark.asyncio
    async def test_lite_save_insert_to_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_lite_save_update_in_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_lite_save_default_unchanged(self):
...
class TestAsyncLiteDeleteDb:
    ...
    @pytest.mark.asyncio
    async def test_lite_delete_from_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_lite_delete_unsaved_raises(self):
...
class TestAsyncLiteSafeSaveDb:
    ...
    @pytest.mark.asyncio
    async def test_lite_safe_save_to_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_lite_safe_increments_version(self):
    ...
    @pytest.mark.asyncio
    async def test_lite_safe_stale_raises(self):
    ...
    @pytest.mark.asyncio
    async def test_lite_safe_rebase_in_alternate_db(self):
...
class TestAsyncCrossCuttingEdgeCases:
    ...
    @pytest.mark.asyncio
    async def test_bulk_save_to_alternate_db(self):
    ...
    @pytest.mark.asyncio
    async def test_save_delete_cycle_across_dbs(self):
    ...
    @pytest.mark.asyncio
    async def test_safe_interleaved_db_saves(self):
    ...
    @pytest.mark.asyncio
    async def test_save_to_third_db(self):
    ...
    @pytest.mark.asyncio
    async def test_delete_wrong_db_is_noop(self):
