...
export default {
  ...
  header: {
    resetDb: 'Reset',
    resetDbTooltip: 'Reset database with sample data',
    resetConfirmTitle: 'Reset Database?',
    resetConfirmMessage: 'This will delete ALL existing data and replace it with fresh sample data. This action cannot be undone.',
  ...
  dashboard: {
    ...
    healthStatus: 'Status',
    healthStatusTooltip: 'Database connection and query health',
    healthy: 'Healthy',
    unhealthy: 'Unhealthy',
    latency: 'Latency',
    latencyTooltip: 'Average query response time',
    dbSize: 'DB Size',
    dbSizeTooltip: 'Total database file size on disk',
    walMode: 'Journal',
    walModeTooltip: 'SQLite journal mode (WAL = Write-Ahead Logging)',
    dbDetails: 'Database Details',
    tableCount: 'Tables',
    indexCount: 'Indexes',
    maintenance: 'Maintenance',
    vacuum: 'Vacuum',
    vacuumTooltip: 'Reorganize database and reclaim free space',
    checkpoint: 'Checkpoint',
    checkpointTooltip: 'Flush WAL to main database file',
    vacuumComplete: 'Vacuum completed',
    checkpointComplete: 'Checkpoint completed',
    viewSchemaTooltip: 'Click to view database schema',
    features: {
      locations: {
        title: 'Locations',
        desc: 'Countries & Cities',
      },
      writers: {
        title: 'Writers',
        desc: 'Audit logging',
  ...
  articles: {
    ...
    rebuildIndexTooltip: 'Rebuild FTS5 full-text search index',
  ...
  schema: {
    ...
    refreshTooltip: 'Reload schema information',
    ...
    explainers: {
      ...
      audit: 'Change history - every create/update/delete is logged with timestamps and diffs',
      fts: 'FTS5 full-text search - SQLite virtual tables for fast text search with ranking',
      system: 'SQLer ORM internals - metadata for migrations and schema versioning',
    },
  },
}
